function(check_co_type CO_TYPE)
    if(NOT("${CO_TYPE}" STREQUAL "PRIVATE" OR "${CO_TYPE}" STREQUAL "PUBLIC" OR "${CO_TYPE}" STREQUAL "INTERFACE"))
        message(FATAL_ERROR "Invalid compile option type: ${CO_TYPE}. Only PRIVATE, PUBLIC or INTERFACE are allowed.")
    endif()
...
function(add_avx2_compile_option TARGET)
    ...
    check_co_type(${CO_TYPE})
    target_compile_options(${TARGET} ${CO_TYPE} $<$<C_COMPILER_ID:MSVC>:/arch:AVX2> $<$<OR:$<C_COMPILER_ID:GNU>,$<C_COMPILER_ID:Clang>,$<C_COMPILER_ID:Intel>>:-mavx2>)
...
function(add_asan_compile_option TARGET)
    ...
    check_co_type(${CO_TYPE})
    target_compile_options(${TARGET} ${CO_TYPE} $<$<C_COMPILER_ID:MSVC>:/fsanitize=address> $<$<OR:$<C_COMPILER_ID:GNU>,$<C_COMPILER_ID:Clang>,$<C_COMPILER_ID:Intel>>:-fsanitize=address>)
    target_link_options(${TARGET} ${CO_TYPE} $<$<OR:$<C_COMPILER_ID:GNU>,$<C_COMPILER_ID:Clang>,$<C_COMPILER_ID:Intel>>:-fsanitize=address>)
