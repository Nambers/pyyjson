...
class TestJsonChecker:
    ...
    def test_pass03(self):
        ...
        self._run_pass_json(
            "pass03.json",
            '{"JSON Test Pattern pass3":{"The outermost value":"must be '
            'an object or array.","In this test":"It is an object."}}',
        )
