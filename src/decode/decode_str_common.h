...
// force_inline bool checkmax_u32(SIMD_TYPE SIMD_VAR, ReadStrState *read_state, u32 lower_bound_minus_1, int target_max_type) {
...
//     return true;
// #else
// #    define CMPGT PYYJSON_CONCAT2(cmpgt_i32, COMPILE_SIMD_BITS)
// #    define BROADCAST PYYJSON_CONCAT2(broadcast_u32, COMPILE_SIMD_BITS)
...
// force_inline bool checkmax_u16(SIMD_TYPE SIMD_VAR, ReadStrState *read_state, u16 lower_bound_minus_1, int target_max_type) {
// #if COMPILE_SIMD_BITS == 512
...
// #    elif COMPILE_SIMD_BITS == 128
// #        define MM_PREFIX _mm
// #    endif
// #    define SUBS PYYJSON_SIMPLE_CONCAT3(MM_PREFIX, _subs_epu, 16)
// #    define BROADCAST PYYJSON_CONCAT3(broadcast, 16, COMPILE_SIMD_BITS)
//     const SIMD_TYPE t = BROADCAST(lower_bound_minus_1);
...
// force_inline bool checkmax_u8(SIMD_TYPE SIMD_VAR, ReadStrState *read_state, u8 lower_bound_minus_1, int target_max_type) {
// #if COMPILE_SIMD_BITS == 512
...
// #    define BROADCAST PYYJSON_CONCAT3(broadcast, 8, COMPILE_SIMD_BITS)
//     const SIMD_TYPE t = BROADCAST(lower_bound_minus_1);
//     SIMD_TYPE mask = SUBS(SIMD_VAR, t);
//     if (unlikely(!check_mask_zero(mask))) {
//         update_max_char_type(read_state, target_max_type);
