...
//     MASK_WRITER(dst, ((AVX512_BITMASK_TYPE)1 << (usize)head_cnt) - 1, SIMD_VAR);
// #            undef MASK_WRITER
// #        else
...
//     if (head_cnt) {
//         *(vector_u_u8_128 *)dst = (vector_u_u8_128)x;
//     }
//     assert(false);
// }
// #endif
...
//     //     static_assert(COMPILE_SIMD_BITS == 256 && COMPILE_WRITE_UCS_LEVEL == 4, "");
...
// #    define BLENDV_WRITER PYYJSON_CONCAT2(blendv_writetail, COMPILE_SIMD_BITS)
