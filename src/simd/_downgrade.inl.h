...
// #if PYYJSON_X86
// force_inline void DOWNGRADE_STRING(const _src_t *src_start, Py_ssize_t copy_count, _dst_t *write_buffer_head) {
...
// #    endif
//     const _src_t *src = (const _src_t *)src_start;
//     _dst_t *dst = (_dst_t *)write_buffer_head;
//     SIMD_TYPE SIMD_VAR;
//     usize _copy_count = (usize)copy_count;
//     usize _loop = _copy_count / READ_BATCH_COUNT;
//     usize _rest = _copy_count % READ_BATCH_COUNT;
// #    if COMPILE_SIMD_BITS == 512
//     if (_copy_count * sizeof(_src_t) < 32) {
...
// #        endif
//         SIMD_256 y = load_256((const void *)(src + copy_count - READ_BATCH_COUNT / 2));
//         SMALL_ZIPTYPE half_val = SMALL_ZIPPER(y);
//         SMALL_ZIP_WRITER(dst + copy_count - READ_BATCH_COUNT / 2, half_val);
// #        undef SMALL_ZIPTYPE
