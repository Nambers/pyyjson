...
// force_inline VECTOR_MASK_TYPE _CHECK_ESCAPE_IMPL_GET_MASK_INTERNAL(vector_a v) {
//     vector_a t1, t2, t3;
//     t1 = SET_ALL(_Quote);
//     t2 = SET_ALL(_Slash);
...
// #    undef CMPLT
// #else
//     vector_a m1 = (vector_a)(v == t1);
//     vector_a m2 = (vector_a)(v == t2);
//     vector_a m3 = (vector_a)(v < t3);
//     return (vector_a)(m1 | m2 | m3);
// #endif
// }

// force_inline VECTOR_MASK_TYPE CHECK_ESCAPE_IMPL_GET_MASK(const _src_t *restrict src, vector_a *restrict _out_vec) {
//     vector_a v = LOAD_U(src);
//     *_out_vec = v;
//     vector_a t1, t2, t3;
//     t1 = SET_ALL(_Quote);
//     t2 = SET_ALL(_Slash);
...
//     bit_mask = mask;
//     assert(bit_mask);
//     u32 done_count = u64_tz_bits(bit_mask); // / sizeof(_src_t);
//     return done_count;
// }
// #    endif
...
//     bit_mask = ~bit_mask;
//     assert(bit_mask);
//     u32 done_count = u32_tz_bits(bit_mask) / sizeof(_src_t);
//     return done_count;
// }
// #    endif
...
//     assert(bit_mask);
//     u32 done_count = u32_tz_bits((u32)bit_mask) / sizeof(_src_t);
//     return done_count;
// }
...
// }
// #elif PYYJSON_AARCH
// // force_inline u32 GET_DONE_COUNT_FROM_MASK(vector_a mask) {
// // }
// #endif
...
//     check_mask[0] = _CHECK_ESCAPE_IMPL_GET_MASK_INTERNAL(PYYJSON_CAST(vector_a *, &vec2)[0]);
//     check_mask[1] = _CHECK_ESCAPE_IMPL_GET_MASK_INTERNAL(PYYJSON_CAST(vector_a *, &vec2)[1]);
...
//     check_mask[0] = _CHECK_ESCAPE_IMPL_GET_MASK_INTERNAL(PYYJSON_CAST(vector_a *, &vec4)[0]);
//     check_mask[1] = _CHECK_ESCAPE_IMPL_GET_MASK_INTERNAL(PYYJSON_CAST(vector_a *, &vec4)[1]);
//     check_mask[2] = _CHECK_ESCAPE_IMPL_GET_MASK_INTERNAL(PYYJSON_CAST(vector_a *, &vec4)[2]);
//     check_mask[3] = _CHECK_ESCAPE_IMPL_GET_MASK_INTERNAL(PYYJSON_CAST(vector_a *, &vec4)[3]);
