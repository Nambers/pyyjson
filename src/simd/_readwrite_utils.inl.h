...
// #define TAIL_WRITE_SIMD_IMPL MAKE_SRW_NAME(tail_write_simd_impl)
...
// #if PYYJSON_X86
// #    if COMPILE_SIMD_BITS == 512 || !PYYJSON_HAS_BLENDV
...
// // #        define EXTRACTOR PYYJSON_CONCAT3(extract, COMPILE_SIMD_BITS, four_parts)
...
// // #        undef EXTRACTOR
// // #    else
// // #        define EXTRACTOR PYYJSON_CONCAT3(extract, COMPILE_SIMD_BITS, two_parts)
// // #        define ELEVATOR PYYJSON_CONCAT5(elevate, COMPILE_READ_UCS_LEVEL, COMPILE_WRITE_UCS_LEVEL, to, COMPILE_SIMD_BITS)
...
// force_inline void TAIL_WRITE_SIMD_IMPL(const _src_t *src, _dst_t *dst, Py_ssize_t tail_count) {
//     // step 1. load the src.
...
// #if _LOAD_WITH_MASKU
//     static_assert(COMPILE_SIMD_BITS == 512, "COMPILE_SIMD_BITS == 512");
// #    define _MASKZ_LOADU PYYJSON_SIMPLE_CONCAT2(_mm512_maskz_loadu_epi, READ_BIT_SIZE)
//     SIMD_TYPE SIMD_VAR = _MASKZ_LOADU(((AVX512_BITMASK_TYPE)1 << tail_count) - 1, (const void *)src);
// #    undef _MASKZ_LOADU
// #else
//     const _src_t *load_start = src + tail_count - READ_BATCH_COUNT;
//     SIMD_TYPE SIMD_VAR = load_simd((const void *)load_start);
// #endif
// #if _NEED_RUNTIME_SHIFT
//     static_assert(COMPILE_SIMD_BITS == 128, "COMPILE_SIMD_BITS == 128");
//     SIMD_VAR = runtime_right_shift_128bits(SIMD_VAR, (READ_BATCH_COUNT - tail_count) * sizeof(_dst_t));
// #endif
...
// #if WR_DIV != 1
// #    define ELEVATOR PYYJSON_CONCAT5(cvt, READ_UNSIGNED_BIT_NAME, to, WRITE_UNSIGNED_BIT_NAME, COMPILE_SIMD_BITS)
// #else
// #    define ELEVATOR
// #endif
// #if !_WRITE_HEAD_FIRST
