...
force_inline void memorize_ascii_to_ucs4(EncodeUnicodeWriter* writer_addr, EncodeUnicodeBufferInfo *unicode_buffer_info, UnicodeInfo *unicode_info) {
...
force_inline void memorize_ascii_to_ucs2(EncodeUnicodeWriter* writer_addr, EncodeUnicodeBufferInfo *unicode_buffer_info, UnicodeInfo *unicode_info) {
    Py_ssize_t len = writer_addr->writer_u8 - (u8 *)GET_VEC_ASCII_START(unicode_buffer_info);
    unicode_info->ascii_size = len;
...
force_inline void memorize_ascii_to_ucs1(EncodeUnicodeWriter* writer_addr, EncodeUnicodeBufferInfo *unicode_buffer_info, UnicodeInfo *unicode_info) {
    Py_ssize_t len = writer_addr->writer_u8 - (u8 *)GET_VEC_ASCII_START(unicode_buffer_info);
    unicode_info->ascii_size = len;
...
force_inline void memorize_ucs1_to_ucs2(EncodeUnicodeWriter* writer_addr, EncodeUnicodeBufferInfo *unicode_buffer_info, UnicodeInfo *unicode_info) {
...
force_inline void memorize_ucs1_to_ucs4(EncodeUnicodeWriter* writer_addr, EncodeUnicodeBufferInfo *unicode_buffer_info, UnicodeInfo *unicode_info) {
    Py_ssize_t diff = writer_addr->writer_u8 - (u8 *)GET_VEC_COMPACT_START(unicode_buffer_info);
    Py_ssize_t len = diff - unicode_info->ascii_size;
    assert(len >= 0);
    unicode_info->u8_size = len;
...
force_inline void memorize_ucs2_to_ucs4(EncodeUnicodeWriter* writer_addr, EncodeUnicodeBufferInfo *unicode_buffer_info, UnicodeInfo *unicode_info) {
