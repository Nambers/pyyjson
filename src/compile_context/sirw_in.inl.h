...
#define MAKE_SIRW_NAME(_x_) PYYJSON_CONCAT5(_x_, _src_t, _dst_t, __IDENT_NAME, COMPILE_SIMD_BITS)
...
//
#define STR_WRITER_IMPL(r_t, w_t) PYYJSON_CONCAT5(_unicode_buffer_append_str_internal, r_t, w_t, __IDENT_NAME, COMPILE_SIMD_BITS)
#define KEY_WRITER_IMPL(r_t, w_t) PYYJSON_CONCAT5(_unicode_buffer_append_key_internal, r_t, w_t, __IDENT_NAME, COMPILE_SIMD_BITS)

#ifdef COMPILE_UCS_LEVEL
// Name creation macros.
#define MAKE_IU_NAME(_x_) PYYJSON_CONCAT3(_x_, __UCS_NAME, __IDENT_NAME)
//
